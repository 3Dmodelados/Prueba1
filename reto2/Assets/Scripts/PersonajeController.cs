   ...
   [SerializeField] private SpriteRenderer spriteRenderer; 
    ...
    void OnCollisionEnter2D (Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Suelo") || collision.gameObject.CompareTag("PlataformaC") || collision.gameObject.CompareTag("PlataformaM"))
        {
            ...
            transform.eulerAngles = new Vector3(0, transform.eulerAngles.y, 0);//esta linea es para restablecer al personaje cuando toca el suelo
    ...
    private void Girar()
    {
        ...
        //(forma de rotar 3)
        //transform.eulerAngles = new Vector3(0, transform.eulerAngles.y + 180, 0); //esta intruccion causa que la camara no renderiza la escena cuando el personaje gira izquierda
